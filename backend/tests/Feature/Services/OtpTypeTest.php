...
test('most codes last five minutes', function (string $type) {
    $otp = app(OtpService::class)->generate('+233241234567', $type);
...
test('an invitation code lasts an hour', function () {
    $otp = app(OtpService::class)->generate('+233241234567', 'invitation');
...
test('an invitation sms explains what to do', function () {
    app(OtpService::class)->generate('+233241234567', 'invitation');
