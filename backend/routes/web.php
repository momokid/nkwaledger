...
//Guest middleware group for routes that should only be accessible to unauthenticated users
...
//Authenticated middleware group for routes that should only be accessible to authenticated users
